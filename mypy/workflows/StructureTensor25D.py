...
def compute_horizontal(lf3dh, shift, config):
    ...
    if(config.structure_tensor_type == "scharr"):
        ...
        for i in range(lf3d.shape[3]):
            ...
            print("apply gaussian filter along 2rd dimension")
            tensor[:, :, :, i, 0] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 0], 1, gaussianOuter3)#Additional Smoothing
            tensor[:, :, :, i, 1] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 1], 1, gaussianOuter3)#Additional Smoothing
            tensor[:, :, :, i, 2] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 2], 1, gaussianOuter3)#Additional Smoothing

            print("apply gaussian filter along 1rd dimension")
            tensor[:, :, :, i, 0] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 0], 0, gaussianOuter1)
            tensor[:, :, :, i, 1] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 1], 0, gaussianOuter1)
            tensor[:, :, :, i, 2] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 2], 0, gaussianOuter1)

            print("apply gaussian filter along 2rd dimension")
            tensor[:, :, :, i, 0] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 0], 2, gaussianOuter2)
            tensor[:, :, :, i, 1] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 1], 2, gaussianOuter2)
            tensor[:, :, :, i, 2] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 2], 2, gaussianOuter2)
...
def compute_vertical(lf3dv, shift, config):
    ...
    if(config.structure_tensor_type == "scharr"):
        ...
        for i in range(lf3d.shape[3]):
            ...
            print("apply gaussian filter along 3rd dimension")
            tensor[:, :, :, i, 0] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 0], 1, gaussianOuter2)
            tensor[:, :, :, i, 1] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 1], 1, gaussianOuter2)
            tensor[:, :, :, i, 2] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 2], 1, gaussianOuter2)
            ...
            print("apply gaussian filter along 2rd dimension")
            tensor[:, :, :, i, 0] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 0], 2, gaussianOuter3)#Additional Smoothing
            tensor[:, :, :, i, 1] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 1], 2, gaussianOuter3)#Additional Smoothing
            tensor[:, :, :, i, 2] = vigra.filters.convolveOneDimension(tensor[:, :, :, i, 2], 2, gaussianOuter3)#Additional Smoothing
